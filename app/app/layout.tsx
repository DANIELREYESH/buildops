      ...
      <div className="h-screen bg-background flex overflow-hidden">
        ...
        >
          ...
          <div className="px-3 pb-1 flex-shrink-0">
            <button
              onClick={() => { router.push('/app/field'); setMobileOpen(false) }}
            ...
            <div className="flex items-center gap-2.5 px-0.5">
              ...
              {expanded && (
                <>
                  ...
                  <button onClick={() => router.push('/app/users')} className="text-text-muted hover:text-text-primary transition-colors flex-shrink-0" title="Settings">
                    <Settings size={14} />
                  </button>
            ...
            <div className="flex items-center gap-3 ml-auto">
              ...
              <DropdownMenu.Root>
                ...
                <DropdownMenu.Portal>
                  ...
                  >
                    <DropdownMenu.Item
                      onSelect={() => router.push('/app/projects?new=1')}
                    ...
                    <DropdownMenu.Item
                      onSelect={() => router.push('/app/tasks?new=1')}
                      className="flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-xs text-text-secondary cursor-pointer outline-none hover:bg-muted hover:text-text-primary"
                    >
                      <ListPlus size={14} /> New Task
                    </DropdownMenu.Item>
                    <DropdownMenu.Item
                      onSelect={() => router.push('/app/invoicing?new=1')}
                      className="flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-xs text-text-secondary cursor-pointer outline-none hover:bg-muted hover:text-text-primary"
                    >
