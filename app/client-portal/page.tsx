    ...
    <AppLayout>
      <div className="pt-6 px-6 pb-12">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-text-primary">Client Portal</h1>
            <p className="text-sm text-text-secondary mt-0.5">Live project progress shared with clients. Select a project to view the full status report.</p>
          </div>
              ...
              <div className="col-span-2">
                ...
                {detailLoading ? (
                  ...
                  <div className="bg-surface border border-border rounded-xl p-10 text-center">
                    ...
                    <p className="text-sm text-text-secondary mt-0.5">Check-ins from your site team will appear here</p>
                  </div>
                ) : (
          ...
          <div>
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-sm text-text-secondary mt-0.5">Create a project first to use the client portal</p>
              </div>
            ) : (
              <div className="grid grid-cols-3 gap-4">
                {projects.map(p => {
